        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header bgsize-primary-4 white card-header">
                    <h4 class="card-title"> Esporta dati in Excel</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('importIscrizioni') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <fieldset>
                            <label>Segliere il file Iscrizioni da caricare <small
                            ...
                            <div class="minput-group">
                                ...
                                <div class="input-group-append" id="button-addon2">
                                    <button class="btn btn-primary square btn-sm cae" type="submit"><i
                                            class="ft-upload mr-1"></i> Carica Iscrizioni Excel</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>
            ...
            <div class="pull-right--">
                ...
                <a href="{{ url('exportIscrizione') }}" class="btn btn-primary btn-sm cae">Esporta Iscrizioni in Excel </a>
